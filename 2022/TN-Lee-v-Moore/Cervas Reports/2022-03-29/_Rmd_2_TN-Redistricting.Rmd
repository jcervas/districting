...
# TN_pop.blocks <- read.csv("/Users/cervas/My Drive/GitHub/Data Files/Census/TN2020.pl/clean data/TN_blocks.csv")
...
# tn_enacted_block <- read.csv("/Users/cervas/My Drive/Projects/Redistricting/2022/TN/Plans/2022 Enacted/TN 2022 House Enacted-block-assignments.csv")
source("https://raw.githubusercontent.com/jcervas/R-Functions/main/GERRYfunctions.R")

TN_pop.counties <- read.csv("/Users/cervas/My Drive/GitHub/Data Files/Census/TN2020.pl/clean data/TN_county.csv")
...
TN.vtd <- rgdal::readOGR("/Users/cervas/My Drive/GitHub/Data Files/Census/TN2020.pl/GIS/vtd/TN_vtd20.shp")
	TN.vtd <- TN.vtd[!paste0("47", TN.vtd@data$COUNT) %in% exc.cnty, ]
# rgdal::writeOGR(TN.vtd, "/Users/cervas/Downloads/", layer= "short-TN-vtd", driver="ESRI Shapefile", overwrite_layer=T)
png(paste0("/Users/cervas/Downloads/TN-short-vtd.png"), 
...
apple_seed <- read.csv("/Users/cervas/My Drive/Projects/Redistricting/2022/TN/Plans/Apple Seed/short - apple-seed-precinct-assignments.csv", colClasses=c("character"))
orange_seed <- read.csv("/Users/cervas/My Drive/Projects/Redistricting/2022/TN/Plans/Orange Seed/short - orange-seed - precinct-assignments.csv", colClasses=c("character"))
...
```{r, echo=F, message=FALSE, warning=FALSE, include=FALSE, eval=FALSE}
	urban.counties.districts <- read.csv("/Users/cervas/My Drive/Projects/Redistricting/2022/TN/Plans/Urban Counties Enacted/TN 2022 House Enacted - Urban counties-district-statistics.csv")
...
apple.plans <- c(
	...
	plans.tmp <-read.csv(paste0("/Users/cervas/My Drive/Projects/Redistricting/2022/TN/Plans/Apple/", apple.plans[i], "-PAF.csv"), colClasses=c("character"))
	...
	vtd.tmp@data <- dplyr::left_join(vtd.tmp@data, cols(vtd.tmp@data$District), by="District")
		...
		plan.dev <- (plan.districts[,2]-ideal.house)/ideal.house
			mean(abs(plan.dev))
png(paste0("/Users/cervas/Downloads/", apple.plans[i], ".png"), 
...
orange.plans <- c(
	...
	plans.tmp <-read.csv(paste0("/Users/cervas/My Drive/Projects/Redistricting/2022/TN/Plans/Orange/", orange.plans[i], "-PAF.csv"), colClasses=c("character"))
	...
	vtd.tmp@data <- dplyr::left_join(vtd.tmp@data, cols(vtd.tmp@data$District), by="District")
		...
		plan.dev <- (plan.districts[,2]-ideal.house)/ideal.house
			mean(abs(plan.dev))
png(paste0("/Users/cervas/Downloads/", orange.plans[i], ".png"), 
